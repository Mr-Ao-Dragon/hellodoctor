<template>
  ...
  -->
	...
	<view class="content">
				...
				<view class="noticent">
					<swiper :vertical="true" :autoplay="true" style="height: 40rpx;line-height: 40rpx;">
						<swiper-item class="u-font-dan-sheng" v-for="(item,index) in noti" :key="index">
							<text class="u-font-28 u-color-balck3 u-font-dan-sheng"
								style="width: 620rpx;">{{item}}</text>
						</swiper-item>
					</swiper>
				</view>
		...
		<!--列表-->
		<view class="u-flex-col gxcent u-margin-bottom-20 u-border-ra20 u-bg-white u-margin-top-20"
			...
			<view v-for="(item,index) in list" :key="index" class="u-padding-20 u-flex border-bootom-1"
...
<script>
	...
	import {
		getTime
	} from "@/uni_modules/uni-datetime-picker/components/uni-datetime-picker/util";
	...
	export default {
		data() {
			return {
				...
				expiresIn: uni.getStorageSync('expries_in'),
			}
		},
